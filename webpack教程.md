...
1、@babel/polyfill会造成代码非常冗余，导致打包后的体积过大，这是因为babel会在转换每个JS高阶版本语法的时候，都直接重新定义相关的函数，而不是对已有函数的调用。
...
@babel/runtime：由Babel提供的polyfill套件，由core-js和regenerator组成。提供了一些辅助函数，ES6转码时，babel会需要一些辅助函数，例如_extend函数，@babel/runtime就是这些函数的集合。
...
![image-20210407223603345](https://tva1.sinaimg.cn/large/008eGmZEly1gpbk20ypf5j30fu0bvjs4.jpg)

![image-20210407223626251](https://tva1.sinaimg.cn/large/008eGmZEly1gpbk2fjp1lj30rs051aau.jpg)
